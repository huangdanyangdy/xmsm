...
Page({
	...
	// 
	 selectgoodsStar(e) {
        ...
        goodStatus = e.currentTarget.dataset.goodStatus
        console.log(e)
        that.setData({
            starNum: index,
        })
  ...
  OnSubmit(){
    ...
    if (goodStatus =='' || refundReason==''){
      ...
      // 提交退款信息
      let data = { ordersId: ordersId, goodsId: goodsId, goodStatus: goodStatus, refundReason: refundReason, refundExpress: refundExpress, refundPic: files }
      ...
      // wx.navigateTo({
      //   url: '/orders/pages/refund-msg/refund-msg' 
      // })
    }
  },
  // 上传照片
  selectPhoto(){
    var _this = this
    // let uploadUrl = a.globalRequestUrl('domainNameA', 'uploadImg')
    wx.showActionSheet({
      itemList: ['从相册选择'],
      success(res) {
        //拍照
